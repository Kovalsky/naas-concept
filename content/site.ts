...
export const ROUTES = {
  ...
  international: '/mizhnarodna-diyalnist',
  exhibitions: '/vystavkova-diyalnist',
  innovation: '/innovatsiyna-diyalnist',
...
export const FOOTER = {
  sections: [
    ...
    { label: 'Міжнародна діяльність', href: ROUTES.international, k: 'footer.s.international' },
    { label: 'Виставкова діяльність', href: ROUTES.exhibitions, k: 'footer.s.exhibitions' },
    { label: 'Інноваційна діяльність', href: ROUTES.innovation, k: 'footer.s.innovation' },
  ],
  documents: [
...
export const SEARCH_INDEX: { title: string; href: string }[] = [
  ...
  { title: 'Міжнародна діяльність', href: ROUTES.international },
  { title: 'Виставкова діяльність', href: ROUTES.exhibitions },
